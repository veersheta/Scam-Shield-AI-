...
const RecoveryToolkit: React.FC = () => {
  ...
  return (
    <div className="bg-light-glass dark:bg-dark-glass backdrop-blur-xl p-6 md:p-8 rounded-2xl border border-white/20">
      <h3 className="text-2xl font-bold text-light-text-primary dark:text-dark-text-primary mb-2">Fraud Recovery & Response Center</h3>
      <p className="text-light-text-secondary dark:text-dark-text-secondary mb-6">If you've been targeted by digital fraud, immediate action is critical. Use these verified resources for incident response and recovery.</p>
