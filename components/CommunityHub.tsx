  ...
  return (
    <div className="bg-light-glass dark:bg-dark-glass backdrop-blur-xl p-6 md:p-8 rounded-2xl border border-white/20">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <div>
            <h3 className="text-2xl font-bold text-light-text-primary dark:text-dark-text-primary mb-2">Crowdsourced Threat Intelligence</h3>
            <p className="text-light-text-secondary dark:text-dark-text-secondary">Leverage real-time, community-driven data on emerging digital threats. Contribute reports to strengthen our collective defense against online fraud.</p>
        </div>
